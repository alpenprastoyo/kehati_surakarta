    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h6 class="page-title">DATA POHON PADA TITIK LOKASI <span style="text-transform:uppercase">{{ $rth->lokasi }}</span> </h6>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">DATA POHON PADA TITIK LOKASI <span style="text-transform:uppercase">{{ $rth->lokasi }}</span> </h4>
