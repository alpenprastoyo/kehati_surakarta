    ...
    <div class="page-title-box">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h6 class="page-title">DETAIL BURUNG</h6>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="carousel-inner galery" role="listbox">
                                            ...
                                            <div class="carousel-item active">
                                                <img height="500" class="d-block img-fluid"
                                                    src="{{ asset('/img/burung/'.$burung->image) }}" alt="0">
                                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{ $burung->nama_jenis }}" type="text"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{ $burung->spesies }}" type="text"
                                        placeholder="Artisanal kale" id="example-text-input" disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{ $burung->iucn }}" type="text"
                                        placeholder="Artisanal kale" id="example-text-input" disabled>
                                </div>
                            </div>
                        </div>
